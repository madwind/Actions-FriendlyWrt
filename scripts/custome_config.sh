...
# Restore only the explicit user-space package selections used by the official
# OpenWrt rockchip/armv8 release builds. Normal router packages such as
# dnsmasq, firewall4, nftables, odhcp6c and PPP come from OpenWrt target/device
# defaults and are intentionally not duplicated here.
...
# OpenWrt 24.10 rockchip/armv8 release user-space package set.
CONFIG_PACKAGE_cgi-io=y
CONFIG_PACKAGE_libiwinfo=y
CONFIG_PACKAGE_libiwinfo-data=y
CONFIG_PACKAGE_liblucihttp=y
